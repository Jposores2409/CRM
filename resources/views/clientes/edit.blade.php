...
<div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pt-16">
    ...
    <div class="mb-8">
        ...
        <h1 class="font-['Syne'] text-3xl font-extrabold text-gray-900">
            Editar <span class="text-cyan-600">Cliente</span>
        </h1>
        <p class="text-gray-400 text-sm mt-1">Modificá los datos de {{ $cliente->nombre }}</p>
    </div>
        ...
        <form method="POST" action="/clientes/{{ $cliente->id }}">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nombre"
                    ...
                    class="w-full bg-gray-50 border rounded-lg px-4 py-2.5 text-sm text-gray-800 outline-none transition-all
            ...
            <div class="mb-7">
                ...
                <select name="status" class="w-full border rounded px-3 py-2" value="lead"{{ old('status', $cliente->status) }}>
